...
wp_enqueue_style('rela-features-single-modern', $sc_dir . 'assets/css/cs_layout3.css', null, null);

?>
<div <?php $this->render_attribute_string('wrapper'); ?>>

	<div <?php $this->render_attribute_string('block_wrapper'); ?>>
		<a class="aheto-features-block__wrap" href="<?php echo esc_attr($cs_link_url);?>">
			<?php if ( $s_image ) : ?>
