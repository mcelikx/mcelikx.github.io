...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-pricing aheto-pricing--rela-narrow' );
...
wp_enqueue_style('rela-pricing-tables-narrow', $sc_dir . 'assets/css/cs_layout4.css', null, null);
...
<div <?php $this->render_attribute_string( 'wrapper' ); ?>>
	...
	<div class="aheto-pricing__content">
		...
		// Button Link.
		if ( $cs_narrow_add_button ) { ?>
			<div class="aheto-pricing__link">
				<?php echo \Aheto\Helper::get_button($this, $atts, 'cs_narrow_'); ?>
			</div>
		<?php }
		?>
