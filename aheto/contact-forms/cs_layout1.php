...
$this->add_render_attribute( 'wrapper', 'class', 'widget widget_aheto__cf--rela__subscribe-simple' );
...
wp_enqueue_style('rela-subscribe-simple', $sc_dir . 'assets/css/cs_layout1.css', null, null); ?>
