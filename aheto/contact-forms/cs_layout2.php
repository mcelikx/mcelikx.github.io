...
$this->add_render_attribute( 'wrapper', 'class', 'widget widget_aheto__cf--rela-classic-form' );
 ...
 * Set dependent style
 */
$sc_dir = RELA_T_URI . '/aheto/contact-forms/';
wp_enqueue_style('rela-cf-classic-form', $sc_dir . 'assets/css/cs_layout2.css', null, null);
wp_enqueue_script( 'rela-cf-classic-form-js', $sc_dir . 'assets/js/cs_layout2.min.js', array( 'jquery' ), null ); ?>
