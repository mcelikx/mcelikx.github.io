...
wp_enqueue_style('rela-navigation-main', $sc_dir . 'assets/css/cs_layout1.css', null, null);
wp_enqueue_script('rela-navigation-main-js', $sc_dir . 'assets/js/cs_layout1.min.js', array( 'jquery' ), null);
...
<div <?php $this->render_attribute_string( 'wrapper' ); ?>>
    <div class="main-header__main-line">
        ...
        <?php if ($cs_scroll_main_add_button) { ?>
