...
$this->add_render_attribute( 'wrapper', 'class', 'widget widget_aheto__contact_info--rela-minimal' );
 ...
 * Set dependent style
 */
$sc_dir = RELA_T_URI . '/aheto/contact-info/';
wp_enqueue_style('rela-contact-info-minimal', $sc_dir . 'assets/css/cs_layout1.css', null, null);
