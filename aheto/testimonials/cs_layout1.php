...
$testimonials = $this->parse_group($cs_testimonials);
...
wp_enqueue_style('rela-testimonials-modern', $sc_dir . 'assets/css/cs_layout1.css', null, null);
wp_enqueue_script( 'rela-testimonials-modern-js', $sc_dir . 'assets/js/cs_layout1.min.js', array( 'jquery' ), null );
	...
	<div class="swiper">
		...
		<div class="swiper-container" <?php echo esc_attr($carousel_params); ?> >
			...
			<div class="swiper-wrapper">
				...
				<?php foreach ( $cs_testimonials as $item ) : ?>
						...
						<div class="aheto-tm__slide-wrap">
							...
							<div class="aheto-tm__author">
								<?php if ( !empty($item['cs_image']) ) : ?>
                                    <?php
                                        $background_image = Helper::get_background_attachment($item['cs_image'], $cs_image_size, $atts, 'cs_');
                                    ?>
