 ...
 * Set dependent style
 */
$sc_dir = RELA_T_URI . '/aheto/custom-post-types/';
wp_enqueue_style('rela-skin-1', $sc_dir . 'assets/css/cs_skin-1.css', null, null);
		...
		<div class="aheto-cpt-article__content">
            ...
            <?php if ( $isHasThumb2 ) { ?>
                <div class="aheto-cpt-article__date">
                    ...
                    if ( !empty( $atts['cs_date_label'] )) {
                        echo '<span>' . ' ' . esc_html( $atts['cs_date_label'] ) . '</span>';
                    }
