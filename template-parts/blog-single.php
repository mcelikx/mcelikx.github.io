...
$content_size_class = is_active_sidebar( 'rela-sidebar' ) ? 'col-12 col-lg-8' : 'col-12'; ?>
...
<div class="rela-blog--single-wrapper <?php echo esc_attr( $protected ); ?>">
    <div class="rela-blog--single__top-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="rela-blog--single__columns">
                        <div class="rela-blog--single__top-content-left">

                            <div class="rela-blog--single__categories">
								<?php the_category( ' ' ); ?>
                            </div>

							<?php the_title( '<h1 class="rela-blog--single__title">', '</h1>' ); ?>

                            <div class="rela-blog--single__date"><?php the_time( get_option( 'date_format' ) ); ?></div>

                        </div>

                        <div class="rela-blog--single__top-content-right">

                            <div class="rela-blog--single__author">
        ...
        <div class="row">
            <div class="col-12 <?php echo esc_attr( $content_size_class ); ?>">
				<?php if ( has_post_thumbnail() ) { ?>
                    <div class="rela-blog--single__banner">
                ...
                <div class="rela-blog--single__content-wrapper">
					...
					<?php the_tags(
						'<div class="rela-blog--single__tags">
				...
				<?php if ( ( is_single() || is_page() ) && ( comments_open() || get_comments_number() ) && ! post_password_required() ) { ?>
                    <div class="rela-blog--single__comments">
						<?php comments_template( '', true ); ?>
                    </div>
				<?php } ?>

                <div class="rela-blog--single__pagination">
                    <div class="rela-blog--single__pagination-prev">
						<?php $prev_post     = get_previous_post();
                            if ( ! empty( $prev_post ) ) :
                                $prev_thumbnail = get_the_post_thumbnail_url( $prev_post->ID, 'thumbnail' );
                                $prev_post_title = ! empty( get_the_title( $prev_post ) ) ? get_the_title( $prev_post ) : esc_html__( 'No title', 'rela' );
                    ...
                    <div class="rela-blog--single__pagination-next">
						<?php if ( ! empty( $next_post ) ) :
							$next_thumbnail = get_the_post_thumbnail_url( $next_post->ID, 'thumbnail' );
							$next_post_title = ! empty( get_the_title( $next_post ) ) ? get_the_title( $next_post ) : esc_html__( 'No title', 'rela' );
			...
			<?php if ( is_active_sidebar( 'rela-sidebar' ) ) {
